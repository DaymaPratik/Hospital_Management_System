    ...
    <div>
      ...
      <div className={styles.doctorsPage}>
        ...
        <section className={styles.hero}>
          ...
          <p>
            Our team of expert doctors are committed to providing the highest
            quality care in a compassionate and personalized manner.
          </p>
        </section>
        ...
        {/* Doctors List */}
        <div className={styles.doctorsPage}>
          <h1 className={styles.meetDoctorsHeading}>Our Doctors</h1>
          <section className={styles.grid}>
            {doctors.map((doc) => (
              <div className={styles.card} key={doc.id}>
                ...
                <p>
                  <strong>Available:</strong> {doc.availableDays},{" "}
                  {doc.availableTime}
                </p>
                <p className={styles.bio}>{doc.bio}</p>
                <div className={styles.buttons}>
                  <a href={`mailto:${doc.email}`} className={styles.emailBtn}>
                    <FaEnvelope /> Email
                  </a>
